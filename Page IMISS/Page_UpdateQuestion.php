...
?>
	...
	<body>		
		New Question:<br>
		<textarea name="newQuestion-Name" id="newQuestion-Id" required></textarea>
		<br>
		Question I.D<br>
		<input type="text" name="questionId-Name" id="questionId-Id" required>
		<br><br>
		<button onclick="submitRequestUpdateQuestion()">Update</button>

				
		<script type="module" src="./Gateway_UpdateQuestion.js"></script>
		<script type="text/javascript" src="./SubmitRequest_UpdateQuestion.js"></script>			
	</body>
	</html>
<?php
