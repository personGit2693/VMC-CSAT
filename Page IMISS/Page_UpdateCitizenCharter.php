...
?>
	...
	<html>
	<head>
		<title>Update Citizen Charter</title>
		<meta charset="utf-8">
		<meta name="viewport" content="width=device-width, initial-scale=1">			
		<link rel="shortcut icon" href="../src/vmclogo.png">
	</head>
	<body>		
		New Citizen Charter Name:<br>
		<textarea name="newCitizenCharterName-Name" id="newCitizenCharterName-Id" required></textarea>
		<br>
		Citizen Charter I.D<br>
		<input type="text" name="citizenCharterId-Name" id="citizenCharterId-Id" required>
		<br><br>
		<button onclick="submitRequestUpdateCcName()">Update</button>

				
		<script type="module" src="./Gateway_UpdateCcName.js"></script>
		<script type="text/javascript" src="./SubmitRequest_UpdateCcName.js"></script>			
	</body>
	</html>
<?php
