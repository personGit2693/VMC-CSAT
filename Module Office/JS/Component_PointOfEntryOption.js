...
function PointOfEntryOption(){
	...
	for(let index=0; index < pointOfEntry_Array.length; index++){
		...
		pointOfEntryOption += `<div class="selectDropdownOpt_RoClass" onclick="displaySelectedOpt(this, '180px'), controller_divOption_SearchAssignSelectedOffice(), controller_SearchArea_SubmitAllRequest()">`+
