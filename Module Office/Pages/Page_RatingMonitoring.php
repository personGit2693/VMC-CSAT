...
?>
	...
	<body>
		...
		<!--Javascripts-->
		<!--_Dependencies-->
		<script type="text/javascript" src="../../Rogrid/Scripts/RogridNodeLayOneNavScript.js?v5"></script>
		<script type="text/javascript" src="../../Rogrid/Scripts/RogridNodeScript.js?v5"></script>
		<script type="text/javascript" src="../../Rogrid/Scripts/CalendarLite.js?v5"></script>
		<script type="text/javascript" src="../../Rogrid/Scripts/Plugin_GstaticChart.js?v5"></script>
		<!--_Dependencies-->

		<!--_Controller-->
		<script type="module" src="../Client Side/Controller_InputText_SearchFindPointOfEntry.js?v5"></script>
		<script type="module" src="../Client Side/Controller_Ahref_HighlightBookmark.js?v5"></script>
		<script type="module" src="../Client Side/Controller_DivBtn_ResetSelectedPointOfEntry.js?v5"></script>
		<script type="module" src="../Client Side/Controller_DivOptionWrap_SearchPopulatePointOfEntry.js?v5"></script>		
		<script type="module" src="../Client Side/Controller_DivOption_AssignSelectedPointOfEntry.js?v5"></script>	
		<script type="module" src="../Client Side/Controller_InputCheckbox_AssignClientTypeInternal.js?v5"></script>
		<script type="module" src="../Client Side/Controller_InputCheckbox_AssignClientTypeExternal.js?v5"></script>
		<script type="module" src="../Client Side/Controller_SearchArea_DisplayMonitoring.js?v5"></script>
		<script type="module" src="../Client Side/Controller_DivCommentsWrap_DisplayComments.js?v5"></script>
		<script type="module" src="../Client Side/Controller_Btn_GenerateOfficeCode.js?v5"></script>
		<!--_Controller-->		

		<!--_Executor-->
		<script type="module" src="../Client Side/Executor_Page_RatingMonitoring.js?v5"></script>
		<!--_Executor-->
		<!--Javascripts-->			
	</body>
	</html>
