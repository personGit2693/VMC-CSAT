...
function controller_Document_DisplayCcTwoScoresTable(){
	...
	submitCitizenCharterTwoScores(outputCitizenCharterTwoScoresTable, selectedPointOfEntry_Obj.office_id, clientTypeInternal, clientTypeExternal, dateRangeOneCalLiteFromVal.value, dateRangeOneCalLiteToVal.value, ccTwo_Id, submitNewRespondentNotifier, currentNewRespondent);
}
/*Controller*/
