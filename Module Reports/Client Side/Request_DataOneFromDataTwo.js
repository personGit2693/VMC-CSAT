...
/*Get Data One*/
async function requestDataOneFromDataTwo(external_clientTypeId, office_id, dateFrom, dateTo){
	...
	const requestPromise = new Promise(function(resolve){
		...
		.then(parseObj => {
			...
			if(parseObj.validAccess !== true){
				...
				console.log("Execution Problem in Request Data One From Data Two!");
...
/*Export*/
export {requestDataOneFromDataTwo, dataOne_Array};
/*Export*/