...
/*Component*/
function SearchAreaPointOfEntryOptionStack(){

	let searchAreaPointOfEntryOptionStack = "";
	...
	for(let index=0; index < pointOfEntryDetails_Array.length; index++){
		...
		searchAreaPointOfEntryOptionStack += `<div class="selectDropdownOpt_RoClass" onclick="displaySelectedOpt(this, '250px'), controller_DivOption_AssignSelectedOffice('`+elemValue+`'), controller_SearchArea_DisplayTables()">`+
	...
	return searchAreaPointOfEntryOptionStack;
}
/*Component*/


/*Export*/
export default SearchAreaPointOfEntryOptionStack;
/*Export*/